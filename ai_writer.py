...
try:
    from bot.config import COOLDOWN_HOURS, AI_ANALYSIS_CHANCE, AI_MAX_BODY_WORDS, MIN_POST_CHARS
    from bot.templates import TOP_GAINERS, MARKET_UPDATES, TECHNICAL_ANALYSIS, ALTCOIN_WATCHLIST, BREAKING_SIGNALS
except ImportError:
